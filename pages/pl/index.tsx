...
const CARDS: CardDescription[] = [
  {
    ...
    imageSrc: pass,
    description:
      "Karta pobytu -to jestpierwszy krok douzyskanie polskiego obywatelstwo.",
  },
  {
    name: "Karty pobytowe dla rodziny",
    imageSrc: cardPass,
    description:
      "Członkowie Twojej rodzinybędzie mógł również otrzymać karty na podstawie zezwolenia na pobyt lub stałego pobytu",
  },
  {
    name: "Podróż",
    imageSrc: travel,
    description:
      "Możliwośćpobyt w innych krajach strefy Schengenstrefy bezwizowe.",
  },
  {
  ...
  },
  {
    ...
    imageSrc: social,
    description:
      "500 zł+ miesięcznieBądź towarzyskipomoc do pełnoletnościdziecko",
  },
  {
    name: "Możliwość użyczenia",
    imageSrc: credit,
    description:
      "Z kartą pobytową pożyczka będzie dla Ciebie dostępnapolskie banki.",
  },
  {
...
const descriptionMain =
  "Doradztwo i pomoc w uzyskaniu karty pobytu w województwie Wielkopolskim";
...
const features = [
  ...
  },
  {
    ...
    description:
      "Przetwarzanie dokumentów dotyczących zezwolenia na pobyt i karty zezwolenia na pobyt",
    icon: CheckBadgeIcon,
  },
  {
...
export default function Lang() {
  ...
  return (
    <>
      <Head>
        <title>
          Parex Partners Przetwarzanie dokumentów dotyczących zezwolenia na
          pobyt i karty zezwolenia na pobyt
        </title>
      ...
      <main>
        <Navbar
          sectionReviews={"Recenzje"}
          sectionServices={"Usługi"}
          sectionAbout={"Korzyści"}
